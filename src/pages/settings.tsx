					...
					<ul className="flex flex-col gap-y-2">
						<li className="flex justify-between flex-col md:flex-row">
							<div className="flex flex-col items-start">
								...
								<span className="text-sm text-gray-400">
									You can set up an encryption key and your clips won't
									even be decrypted by servers
								</span>
							</div>
							<button
						...
						<li className="flex justify-between flex-col md:flex-row">
							<div className="flex flex-col items-start">
								...
								<span className="text-sm text-gray-400">
									You can import the encryption key file if you have a
									backup to restore the encrypted contents
								</span>
							</div>
							<input
								type="file"
					...
					<ul className="flex flex-col gap-y-2">
						...
						<li className="flex justify-between">
							<div className="flex flex-col items-start">
								...
								<span className="text-sm text-gray-400">
									Enable or Disable the archive feature in your account
								</span>
							</div>
							<label
